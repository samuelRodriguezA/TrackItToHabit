  ...
  return (
    <section className="bg-gray-900 dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="mt-8 mb-4 text-4xl tracking-tight font-extrabold text-center  text-white">Contact Us</h2>
        ...
        <form action="#" className="space-y-8">
          ...
          <button type="submit" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">Send message</button>
        </form>
      </div>
    </section>
  )
